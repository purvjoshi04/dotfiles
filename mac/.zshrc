...
alias ndh="pnpm run dev -- --host"
alias nit="pnpm install -d typescript"
alias nt="npx tsc --init"
alias nx="pnpm create next-app@latest"
...
# bun completions
[ -s "/Users/purvjoshi/.bun/_bun" ] && source "/Users/purvjoshi/.bun/_bun"
...
# pnpm
export PNPM_HOME="/Users/purvjoshi/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
